...
public class AimReticle : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Left.transform.position = screenCenterPoint + (Vector2.left * m_CurrentRadius);
        Right.transform.position = screenCenterPoint + (Vector2.right * m_CurrentRadius);
        Top.transform.position = screenCenterPoint + (Vector2.up * m_CurrentRadius);
        Bottom.transform.position = screenCenterPoint + (Vector2.down * m_CurrentRadius);
    }
}
#endif